...
def detect_generic_help(user_text: str) -> bool:
    """Detects general 'how can you help' style queries."""
    text = user_text.lower()
    return any(re.search(pattern, text) for pattern in HELP_INTENT_PATTERNS)


def detect_support_request(user_text: str) -> bool:
